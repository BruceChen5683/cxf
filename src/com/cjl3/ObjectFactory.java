 ...
 * generated in the com.cjl3 package.
...
public class ObjectFactory {
    ...
    private final static QName _Hello_QNAME = new QName("http://cjl3.com/", "hello");
    private final static QName _Hello2_QNAME = new QName("http://cjl3.com/", "hello2");
    private final static QName _Hello2Response_QNAME = new QName("http://cjl3.com/", "hello2Response");
    private final static QName _HelloResponse_QNAME = new QName("http://cjl3.com/", "helloResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cjl3
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://cjl3.com/", name = "hello")
     ...
     */
    @XmlElementDecl(namespace = "http://cjl3.com/", name = "hello2")
     ...
     */
    @XmlElementDecl(namespace = "http://cjl3.com/", name = "hello2Response")
     ...
     */
    @XmlElementDecl(namespace = "http://cjl3.com/", name = "helloResponse")
